...
class Worker:
    pay_book = {'standard_wage': 1000, 'bonus': 100}

    def __init__(self, name, surname, position, income):
        self.name = name
        self.surname = surname
        self.position = position
        self._income = Worker.pay_book[income]
...
class Position(Worker):
    ...
    def get_total_income(self):
        return self._income + Worker.pay_book['bonus']


ivan = Position('Ivan', 'Petrov', 'Manager', 'standard_wage')
print(ivan.position)
